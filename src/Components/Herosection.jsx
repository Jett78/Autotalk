...
const Herosection = () => {
  return (
    <main className="bg-primary max-h-[750px] w-full mt-16 ">
       ...
       <h2 className="animate-slideleft font-semibold sm:text-[42px] px-4 text-xl  text-purple text-center mx-auto max-w-[1096px] tracking-wide leading-[145%]">
          Get Latest updates on what's going on AutoEcosystem in Nepal
        </h2>
        <p className="animate-slideright py-4 px-1 sm:text-[16px] text-[14px] text-gray text-center mx-auto max-w-[1096px]  tracking-wide font-normal">
