...
const News = () => {
  ...
  return (
    <main className="min-h-[750px] bg-lightyellow px-2 pt-20 text-gray">
      <div className="flex flex-wrap gap-8 justify-center ">
        <div>
          <h2 className="text-[24px] text-purple font-semibold pb-4 mb-6">Related News</h2>
        ...
        <section  className="grid 2xl:grid-cols-1 md:grid-cols-2 grid-cols-1 gap-8">
          ...
          >
            <div className="grid gap-2">
              <h2 className="text-[18px]">Subscribe to Our Newsletter</h2>
