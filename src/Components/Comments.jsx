                ...
                <section>
                    <div className="user_card border mb-10 border-slate-300 rounded-xl p-5 flex items-center gap-[10px] w-full md:w-[475px]">
                        ...
                        <div className="detail">
                            <p className='text-zinc-600 mb-[6px]'>Admin</p>
                    ...
                    <div className="cmnt_section">
                        <form action="">
                            <div className="cmnt">
                                <p className='text-zinc-500 mb-[6px]'>Comment</p>
                                <textarea name="" id="" cols="30" rows="10" className='bg-zinc-100 w-full rounded-lg'></textarea>
                            </div>
                            <div className="name_email md:grid grid-cols-2 gap-5 mt-5">
                                <div className="name">
                                    <p className='text-zinc-500 mb-[6px]'>Name</p>
                            ...
                            <div className="chk flex mt-5">
                                <label htmlFor="" className=''>
                                    <input type="checkbox" className='mr-[6px] w-6 h-6 rounded-lg bg-zinc-500' />
                                    <span className='absolute text-zinc-600 '>Save my name, email, and website in this browser for the next time I comment.</span>
                                </label>
                            </div>
