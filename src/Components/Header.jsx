...
const Header = () => {
  ...
  return (
  <div>
     <div className={`" px-2 sm:text-[16px] text-[12px] text-gray text-center py-[4px] font-normal flex flex-wrap items-center justify-center tracking-wide ${ isScrolled ? "hidden" : "block"}`}>
